...
export function NotificationsCenter() {
  ...
  const { notifications, unreadCount, isLoading } = useUnit({
  ...
  const handleNotificationClick = (notification: { id: string; read: boolean; actionUrl?: string }) => {
    if (!notification.read) notificationsModel.markAsRead(notification.id)
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            {unreadCount > 0 && (
              <Button onClick={() => notificationsModel.markAllAsRead()}>
                        ...
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <Button
                              ...
                              onClick={(e) => {
                                e.stopPropagation()
                                notificationsModel.deleteNotification(notification.id)
                              }}
