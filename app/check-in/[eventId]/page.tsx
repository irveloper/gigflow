...
import { Camera, Clock, MapPin, Upload, CheckCircle, ArrowLeft } from "lucide-react"
import { eventsModel } from "@/entities/event/model"
import { addNotification } from "@/entities/notification/model"
  ...
  const handleCheckIn = async () => {
    ...
    try {
      ...
      addNotification({
        ...
        message: "Tu presentación ha sido registrada correctamente",
        type: "success",
        read: false,
      })
      ...
      toast({
        title: "Check-in exitoso",
        description: "Tu presentación ha sido registrada correctamente",
      })
