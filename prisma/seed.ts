...
async function main() {
  ...
  const band1 = await prisma.band.upsert({
    ...
    update: {},
    create: { id: "seed-band-1", name: "Jazz Trio Cancún", description: "Trío de jazz con piano, guitarra y saxofón", genre: "Jazz", pricePerSet: 2400, isActive: true },
  })
  const band2 = await prisma.band.upsert({
    where: { id: "seed-band-2" },
    update: {},
    create: { id: "seed-band-2", name: "Flamenco Fusión", description: "Grupo de flamenco con fusión latina", genre: "Flamenco", pricePerSet: 1800, isActive: true },
  })
  const band3 = await prisma.band.upsert({
    where: { id: "seed-band-3" },
    update: {},
    create: { id: "seed-band-3", name: "Caribbean Sunset Duo", description: "Dúo de bossa nova y música caribeña", genre: "Bossa Nova / Latin", pricePerSet: 1500, isActive: true },
  })
  ...
  // sets = CEIL(original durationMinutes / 60)
  ...
  const events: EventSeed[] = [
...

    {
      ...
      date: "2026-03-05", time: "20:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-03-12", time: "19:30", sets: 2,
    ...
    },
    {
      ...
      date: "2026-03-19", time: "21:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-03-26", time: "18:00", sets: 1,
    ...
    },
    {
      ...
      date: "2026-04-02", time: "17:00", sets: 1,
    ...
    },
    {
      ...
      date: "2026-04-09", time: "20:30", sets: 2,
    ...
    },
    {
      ...
      date: "2026-04-11", time: "19:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-04-16", time: "20:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-04-18", time: "19:00", sets: 1,
    ...
    },
    {
      ...
      date: "2026-04-23", time: "21:00", sets: 2,
      ...H.paradisus, musician: mCarlos.name, musicianId: mCarlos.id,
    ...
    },
    {
      ...
      date: "2026-04-25", time: "16:00", sets: 1,
    ...
    },
    {
      ...
      date: "2026-04-30", time: "11:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-05-03", time: "20:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-05-07", time: "17:30", sets: 1,
    ...
    },
    {
      ...
      date: "2026-05-10", time: "15:00", sets: 1,
    ...
    },
    {
      ...
      date: "2026-05-14", time: "18:30", sets: 2,
    ...
    },
    {
      ...
      date: "2026-05-15", time: "21:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-05-17", time: "20:00", sets: 2,
...

    {
      ...
      date: "2026-05-18", time: "18:00", sets: 1,
      ...H.moon, musician: mLuis.name, musicianId: mLuis.id,
    ...
    },
    {
      ...
      date: "2026-05-18", time: "21:00", sets: 2,
      ...H.paradisus, band: band1.name, bandId: band1.id,
      ...scheduled, organizationId: orgA.id,
    },
...

    {
      ...
      date: "2026-05-20", time: "19:00", sets: 2,
      ...H.iberostar, musician: mCarlos.name, musicianId: mCarlos.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-05-21", time: "10:00", sets: 1,
      ...H.hyatt, musician: mSofia.name, musicianId: mSofia.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-05-22", time: "20:30", sets: 2,
      ...H.moon, band: band2.name, bandId: band2.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-05-24", time: "15:30", sets: 1,
    ...
    },
    {
      ...
      date: "2026-05-28", time: "11:30", sets: 2,
      ...H.hyatt, band: band1.name, bandId: band1.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-05-30", time: "22:00", sets: 2,
...

    {
      ...
      date: "2026-06-04", time: "20:00", sets: 2,
      ...H.moon, musician: mCarlos.name, musicianId: mCarlos.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-06-07", time: "17:00", sets: 1,
    ...
    },
    {
      ...
      date: "2026-06-11", time: "21:00", sets: 2,
      ...H.iberostar, band: band1.name, bandId: band1.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-06-14", time: "20:00", sets: 2,
      ...H.hyatt, band: band2.name, bandId: band2.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-06-18", time: "17:30", sets: 1,
      ...H.moon, musician: mLuis.name, musicianId: mLuis.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-06-21", time: "21:00", sets: 2,
      ...H.paradisus, musician: mCarlos.name, musicianId: mCarlos.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-06-25", time: "19:00", sets: 1,
      ...H.iberostar, musician: mSofia.name, musicianId: mSofia.id,
      ...scheduled, organizationId: orgA.id,
    },
    {
      ...
      date: "2026-06-28", time: "20:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-06-30", time: "20:30", sets: 2,
      ...H.hyatt, band: band1.name, bandId: band1.id,
      ...scheduled, organizationId: orgA.id,
    },
...

    {
      ...
      date: "2026-03-08", time: "11:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-03-15", time: "20:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-03-22", time: "21:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-03-28", time: "19:30", sets: 1,
    ...
    },
    {
      ...
      date: "2026-04-05", time: "15:30", sets: 1,
    ...
    },
    {
      ...
      date: "2026-04-12", time: "17:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-04-19", time: "20:00", sets: 2,
      ...H.paradisus, musician: mMiguel.name, musicianId: mMiguel.id,
    ...
    },
    {
      ...
      date: "2026-04-25", time: "21:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-05-03", time: "20:30", sets: 2,
      ...H.xcaret, band: band3.name, bandId: band3.id,
    ...
    },
    {
      ...
      date: "2026-05-10", time: "17:00", sets: 1,
      ...H.hyatt, musician: mMariaElena.name, musicianId: mMariaElena.id,
    ...
    },
    {
      ...
      date: "2026-05-16", time: "12:00", sets: 2,
      ...H.xcaret, musician: mAna.name, musicianId: mAna.id,
...

    {
      ...
      date: "2026-05-18", time: "20:00", sets: 1,
    ...
    },
    {
      ...
      date: "2026-05-18", time: "21:30", sets: 2,
      ...H.xcaret, band: band3.name, bandId: band3.id,
      ...scheduled, organizationId: orgB.id,
    },
...

    {
      ...
      date: "2026-05-22", time: "19:30", sets: 2,
    ...
    },
    {
      ...
      date: "2026-05-23", time: "16:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-05-29", time: "18:00", sets: 1,
      ...H.xcaret, musician: mMariaElena.name, musicianId: mMariaElena.id,
      ...scheduled, organizationId: orgB.id,
    },
    {
      ...
      date: "2026-06-06", time: "21:00", sets: 2,
      ...H.xcaret, band: band2.name, bandId: band2.id,
      ...scheduled, organizationId: orgB.id,
    },
    {
      ...
      date: "2026-06-13", time: "11:30", sets: 2,
      ...H.hyatt, band: band3.name, bandId: band3.id,
      ...scheduled, organizationId: orgB.id,
    },
    {
      ...
      date: "2026-06-20", time: "20:00", sets: 2,
    ...
    },
    {
      ...
      date: "2026-06-27", time: "19:00", sets: 2,
      ...H.paradisus, musician: mMariaElena.name, musicianId: mMariaElena.id,
      ...scheduled, organizationId: orgB.id,
    },
  ]
